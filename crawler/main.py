...
# 파일 이름 정의
RESULT_FILE_NAME = "emoji_container.json"

# 파일 경로 정의
RESULT_FULL_PATH = os.path.join(DATA_DIR_NAME, RESULT_FILE_NAME)
...
if __name__ == "__main__":
    ...
    with open(RESULT_FULL_PATH, "w", encoding="utf-8") as f:
        f.write(json.dumps({"use": True, "items": data}, indent=2, ensure_ascii=False))
